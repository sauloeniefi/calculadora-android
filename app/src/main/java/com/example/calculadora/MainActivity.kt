...
class MainActivity : AppCompatActivity() {
    ...
    fun calcular(componente: View) {
        ...
        val fraseNaMedia = "Olá $nome, sua média foi $mediaFinal. Você está aprovado, mas passou raspando!"
        val fraseAprovado = "Olá $nome, sua média foi $mediaFinal. Você está aprovado. Parabéns!"
